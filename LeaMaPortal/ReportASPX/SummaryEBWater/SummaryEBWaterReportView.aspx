<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryEBWaterReportView.aspx.cs" Inherits="LeaMaPortal.ReportASPX.SummaryEBWater.SummaryEBWaterReportView" %>
...
<body>
    ...
    <div>
        ...
        <asp:ScriptManager runat="server" ID="SummaryEBWaterReportScript" ScriptMode="Release"></asp:ScriptManager>
        <div runat="server" visible="false" id="SummaryEBWaterReport">
            <rsweb:ReportViewer ID="SummaryEBWaterReportViewer" runat="server" width="100%" height="700px" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            </rsweb:ReportViewer>
        </div>
    </div>
    </form>
