<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutstandingReportView.aspx.cs" Inherits="LeaMaPortal.ReportASPX.Outstanding.OutstandingReportView" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager runat="server" ID="OutstandingReportScript" ScriptMode="Release"></asp:ScriptManager>
        <div runat="server" visible="false" id="OutstandingReport">
