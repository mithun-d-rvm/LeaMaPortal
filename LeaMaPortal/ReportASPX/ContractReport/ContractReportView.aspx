<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractReportView.aspx.cs" Inherits="LeaMaPortal.ReportASPX.ContractReport.ContractReportView" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager runat="server" ID="ContractReportScript" ScriptMode="Release"></asp:ScriptManager>
        <div runat="server" visible="false" id="ContractReport">
            <rsweb:ReportViewer ID="ContractReportViewer" runat="server" width="100%" height="1033px" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            </rsweb:ReportViewer>
        </div>
    </div>
    </form>
